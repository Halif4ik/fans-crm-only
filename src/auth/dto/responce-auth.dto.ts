...
export class AuthResponse implements GeneralResponse<TAuthResponse> {
  ...
  @ApiProperty({
    example: {
      action_token:
        "eyJhbGciOiJIUzI1wiZmlyc3ROYW1lIjoiJTNDaDElM0VKb2huJTNDL2wNTY4LCJIXG-01lZrA9RKUk",
      refreshToken:
        "eyJhbGciOiJIUzI6MSwiZmlyc3ROYW1lIjoiJTNDaDElM0VF0IjoxNzEwNTQwNTY4MTA1NDQxNji3etiJJMR-7B4",
      accessToken:
        "eyJhbGciOiJIUzI16MSwiZmlyc3ROYW1lIjoiJTNDaDElM0VKb2hF0IjoxNzEwNTQwNTYanxBEz1ipvT2gw",
      userId: 1
    }
  })
